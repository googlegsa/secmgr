...
/**
 * This class implements a HTTP service that is slow and timeout on requests.
 */
public class MockSlowServer extends ServletBase
    implements GettableHttpServlet, PostableHttpServlet {
  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
    throw new InterruptedIOException("slow");
  }
