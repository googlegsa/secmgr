...
public abstract class SamlServlet extends ServletBase {
   ...
   */
  @Nonnull
  public MessageContext<SAMLObject> makeSamlMessageContext(HttpServletRequest request)
      throws IOException {
   ...
   *     SamlSharedData#makeSamlMessageContext}.
  ...
  /**
   * Initializes the peer entity components in an OpenSAML message-context object. Assumes the
   * peer's entity ID has been decoded from a request message.
   *
   * @param context A context to be initialized, which must have been generated by {@link
   *     SamlSharedData#makeSamlMessageContext}.
   * @param endpointType The type of the peer's endpoint.
   ...
   */
  public void initializePeerEntity(
      MessageContext<SAMLObject> context, QName endpointType, String binding)
      throws IOException {
    SAMLPeerEntityContext peerEntityContext = context.getSubcontext(SAMLPeerEntityContext.class);
    sharedData.initializePeerEntity(
        context, peerEntityContext.getEntityId(), endpointType, binding);
  }
}
