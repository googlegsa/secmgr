...
public class XmlUtil {
   ...
   *
   * @param output An output stream to which the output will be written.
   * @return An LSOutput object correspoding to the given output stream.
   */
  public LSOutput getLsOutput(OutputStream output) {
