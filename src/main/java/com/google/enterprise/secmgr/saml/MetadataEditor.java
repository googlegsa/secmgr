...
public class MetadataEditor {
  ...
  private static final String SECMGR_CLIENTS_ENTITIES_COMMENT = "SAML client IdPs";
  ...
  // Entity for GSA/Security Manager.
  static final String GSA_ENTITY_ID_MARKER = "${GSA_ENTITY_ID_MARKER}";
  private static final String GSA_ENTITY_COMMENT = "Description of the GSA";
  static final String GSA_ID_FOR_ENTITY = "GSA";
  static final String SECMGR_ENTITY_ID_MARKER = "${SECMGR_ENTITY_ID_MARKER}";
  private static final String SECMGR_ENTITY_COMMENT = "Description of the Security Manager";
  ...
  public static class SamlClientIdp {
    ...
    @Override
    public int hashCode() {
      return Objects.hash(id, loginUrl, artifactUrl, certificate, authzServiceUrl);
    }
    ...
    public boolean equals(Object obj) {
      ...
      return Objects.equals(id, other.id)
          ...
          && Objects.equals(artifactUrl, other.artifactUrl)
          && Objects.equals(certificate, other.certificate)
          && Objects.equals(authzServiceUrl, other.authzServiceUrl);
    }
  }
  ...
  public static Document makeOnboardSecurityManagerMetadata() {
    ...
    makeGsaEntity(entities);
    makeSmEntity(entities);
    return document;
  }
   ...
   */
  private static Element makeGsaEntity(Element entities) {
    Element entity = makeTopLevelEntity(entities, GSA_ENTITY_ID_MARKER, GSA_ENTITY_COMMENT);
    entity.setAttribute(XML_ATTR_ID, GSA_ID_FOR_ENTITY);
   ...
   * @return The EntityDescriptor as a DOM element.
   */
  private static Element makeSmEntity(Element entities) {
    Element entity = makeTopLevelEntity(entities, SECMGR_ENTITY_ID_MARKER, SECMGR_ENTITY_COMMENT);
