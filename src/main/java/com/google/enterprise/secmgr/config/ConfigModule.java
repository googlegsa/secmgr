...
public final class ConfigModule extends AbstractModule {
  ...
  public ConfigModule(String configFilename) {
    ...
    logger.info("conf " + configFilename);
  }

  @Override
  protected void configure() {
    logger.info("About to configure " + configFilename);
  ...
  public static void registerTypeAdapters(GsonBuilder builder) {
    ...
    AuthnMechGroups.registerTypeAdapters(builder);
    AuthnMechNtlm.registerTypeAdapters(builder);
    AuthnMechPreauthenticated.registerTypeAdapters(builder);
