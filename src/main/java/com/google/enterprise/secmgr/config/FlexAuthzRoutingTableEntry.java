...
public class FlexAuthzRoutingTableEntry {
  ...
  public static boolean isValidPattern(String patternStr) {
    ...
    try {
      new ParsedUrlPattern(patternStr);
  ...
  public synchronized boolean equals(Object object) {
    ...
    return Objects.equals(getUrlPattern(), other.getUrlPattern())
        && Objects.equals(getAuthzRule(), other.getAuthzRule());
  }

  @Override
  public synchronized int hashCode() {
      return Objects.hash(getUrlPattern(), getAuthzRule(), getUniqueRowId());
  }
