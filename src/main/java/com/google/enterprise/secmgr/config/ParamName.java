...
public enum ParamName {
  ...
  GROUPS_FEED_FILENAME(String.class, "../../../../../data/feeds/groups_feed.enterprise"),
  ...
  PROXY_CONF_FILENAME(String.class, "../../../../conf/proxies.enterprise"),
  TRUST_FILENAME(String.class, "../../../../conf/trust.enterprise"),
  GLOBAL_BATCH_REQUEST_TIMEOUT(Float.class, Float.valueOf(5.0f)),
  GLOBAL_SINGLE_REQUEST_TIMEOUT(Float.class, Float.valueOf(2.5f)),
