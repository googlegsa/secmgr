...
public final class AuthnMechConnector extends AuthnMechanism {
  ...
  public static AuthnMechConnector make(String name, String connectorName,
      boolean doGroupLookupOnly, int timeout, long trustDuration) {
    return new AuthnMechConnector(name, connectorName, doGroupLookupOnly, timeout, trustDuration);
  }

  /**
   * Makes a new connector mechanism with a default timeout and trust duration.
   *
   * @param name The name for the new mechanism.
   * @param connectorName The name of the connector to use.
   * @param doGroupLookupOnly To do only groups lookup and not authentication.
  ...
  public static AuthnMechConnector make(String name, String connectorName,
    ...
    return make(name, connectorName, doGroupLookupOnly, NO_TIME_LIMIT, getDefaultTrustDuration());
  }

  private AuthnMechConnector(String name, String connectorName, boolean doGroupLookupOnly,
      int timeout, long trustDuration) {
    super(name);
  ...
  public AuthnMechanism copyWithNewName(String name) {
    return make(name, getConnectorName(), doGroupLookupOnly(), getTimeout(), getTrustDuration());
  }
  ...
  public boolean equals(Object object) {
    ...
    return super.equals(mech)
        && Objects.equals(getConnectorName(), mech.getConnectorName())
  ...
  @Override
  public int hashCode() {
    return super.hashCode(getConnectorName(), getTimeout(), getTrustDuration());
  }
  ...
  private static final class LocalProxy extends MechanismProxy<AuthnMechConnector> {
    ...
    public AuthnMechConnector build() {
      return make(name, connectorName, doGroupLookupOnly, timeout, trustDuration);
    }
  }
}
