...
public class CredentialGroup implements Serializable {
  ...
  public static final class Builder {
    ...
    public AuthnMechanism getFirstMechanismOfType(Class<? extends AuthnMechanism> type) {
    ...
    public List<AuthnMechanism> getAllMechanismOfType(Class<? extends AuthnMechanism> type) {
      List<AuthnMechanism> mechs = Lists.newArrayList();
      for (AuthnMechanism mech : mechanisms) {
        if (type.isInstance(mech)) {
          mechs.add(mech);
        }
    ...
    public Builder updateAuthnGroupsMechanism(AuthnMechGroups groups) {
      // There will be only one Groups Mechanism for each CG.
      AuthnMechanism mech = getFirstMechanismOfType(AuthnMechGroups.class);
      if (mech != null) {
        mechanisms.remove(mech);
        mechanisms.add(groups);
      }
      return this;
    }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(name, other.name)
        ...
        && Objects.equals(requiresUsername, other.requiresUsername)
        && Objects.equals(requiresPassword, other.requiresPassword)
        && Objects.equals(isOptional, other.isOptional)
        && Objects.equals(mechanisms, other.mechanisms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, requiresUsername, requiresPassword, isOptional,
        mechanisms);
  }
