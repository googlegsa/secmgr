...
public interface HttpExchange {
  ...
  /**
   * Sets credentials to use for HTTP Basic authentication.
   *
   ...
   *
   * @param timeout If positive, set the socket timeout to this value.
  ...
  /**
   * Gets the response entity (body) as a byte array.
   *
   * @return The entity byte array.
   * @throws IOException if there's a transport error.
   */
  @Nonnull
  public byte[] getResponseEntityAsByteArray() throws IOException;
  ...
  /**
   * Gets the charset returned by the server.
   * @return The charset.
   */
  @Nonnull
  ...
  /**
   * Closes the exchange and reclaims its resources.
   */
  public void close();
}
